                ...
                {isLoading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {budgets.map((budget: any) => (
                            <div key={budget.id} className="bg-white rounded-2xl shadow-xl p-6">
                                ...
                                <div className="space-y-2 mb-4">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        <span className="text-gray-600">{budget.percentage.toFixed(1)}% usado</span>
                                ...
                                {budget.percentage >= 80 && (
                                    <div className={`text-sm p-3 rounded-lg ${budget.percentage >= 100 ? 'bg-red-50 text-red-700' : 'bg-yellow-50 text-yellow-700'}`}>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-gray-600 mb-4">No tienes presupuestos configurados</p>
                        <button
                            onClick={() => setShowModal(true)}
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-2xl p-8 max-w-md w-full">
                        <h2 className="text-2xl font-bold mb-6">Nuevo Presupuesto</h2>
